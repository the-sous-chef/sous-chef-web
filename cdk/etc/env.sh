...
export REPOSITORY_ARN=$(aws --endpoint-url=http://localhost:4566 ecr describe-repositories --repository-name thesouschef-ecr --query 'repositories[].repositoryArn' --output text)
